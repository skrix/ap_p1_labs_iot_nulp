...
# Створити клас Автомобіль (brand, age, maxSpeed, horse_Power, і тд).
# Зробити поле марки enum.
# Створити клас Паркінг з колекцією автомобілів і максимальною кількістю місць.
# У разі відсутності вільних місць виводити повідомлення про переповнення стоянки.
# Присвоїти ціну однієї години стоянки.
# Додати методи parkCar, leaveParking.
# Посортувати машини за тривалістю стоянки та порахувати ціну паркінгу для кожної.
# main.py
